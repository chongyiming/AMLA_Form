...
return [
    ...
    'lte' => [
        'array' => ':attribute 必须小于或等于 :value 个元素。',
    ...
    'password' => [
        ...
        'uncompromised' => '给定的 :attribute 已在数据泄露中出现过，请选择其他 :attribute。',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | 您可以在此处使用 "attribute.rule" 的约定来为属性指定自定义验证消息，
    | 这使得为给定属性规则快速指定特定的自定义语言行变得简便。
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | 以下语言行用于将属性占位符替换为更易读的内容，例如将 "email"
    | 替换为 "邮箱地址"，这有助于使我们的消息更具表达力。
    |
    */
