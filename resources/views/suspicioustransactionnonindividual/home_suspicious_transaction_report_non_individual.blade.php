...
<body>
    ...
    <div class="header">
        <h1>{{ $branch->Branch_Code }} Suspicious Transaction Report - Non Individual</h1>
        <button type="button" class="btn btn-outline-success" onclick="window.location.href = '/showSuspiciousTransactionReportNonIndividual'">Create Form</button>
