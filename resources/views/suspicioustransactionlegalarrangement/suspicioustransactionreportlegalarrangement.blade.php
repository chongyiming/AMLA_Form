    ...
    <form method="POST" action="{{ $state == 0 ? '/createSuspiciousTransactionReportNonIndividual' : '/submitSuspiciousTransactionReportNonIndividual' }}">
        ...
        <div class="a4_container" id="a4_container">
            ...
            <div id="print-area" style="width:100%;padding:0">
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage1')
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage2')
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage3')
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage4')
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage5')
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage6')
                @include('suspicioustransactionlegalarrangement.suspicioustransactionreportlegalarrangementpage7')
