...
<body>
    ...
    <div class="header">
        <h1>{{ $branch->Branch_Code }} Suspicious Transaction Report - Legal Arrangement</h1>
        <button type="button" class="btn btn-outline-success" onclick="window.location.href = '/showSuspiciousTransactionReportLegalArrangement'">Create Form</button>
