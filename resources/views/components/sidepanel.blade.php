            ...
            <div class="header-dropdown">
                ...
                <div class=" header-dropdown-menu">
                    ...
                    <div style="display: flex;justify-content: space-between;gap:10px">
                        ...
                        @elseif ($formType == "Form_No_4c")
                        <button type="submit"
                            class="btn btn-outline-primary"
                            data-i18n="messages.update"
                            formaction="/updateSuspiciousTransactionReportLegalArrangement/{{ $form1->form_id }}">
                        </button>
                        @endif
                        <button type="button" class="btn btn-outline-danger" onclick="clearForm()" data-i18n="messages.clear"></button>
                        @if ($formType == "Form_No_1")
                        ...
                        @elseif ($formType == "Form_No_4c")
                        <button type="submit" class="btn btn-outline-success" formaction="/submitSuspiciousTransactionReportLegalArrangement/{{ $form1->form_id }}" data-i18n="messages.submit"></button>
                        @endif
                        @elseif($state ==2)
