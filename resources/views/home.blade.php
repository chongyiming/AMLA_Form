...
<body>
    <div class="a4_container">
        ...
        <div class="form-choice-box">
            ...
            <button type="button" class="btn btn-info" onclick="window.location.href='/home_suspicious_transaction_report_legal_arrangement'">Suspicious Transaction Report - Legal Arrangement 可疑交易报告 - 法律安排</button>
        </div>
