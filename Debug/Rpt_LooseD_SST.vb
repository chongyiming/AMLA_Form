...
Public Class Rpt_LooseD_SST
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "produceCert_Receipt.Rpt_LooseD_SST.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_LooseD_SST
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_LooseD_SST = New Rpt_LooseD_SST()
        rpt.Site = Me.Site
        Return rpt
    End Function
